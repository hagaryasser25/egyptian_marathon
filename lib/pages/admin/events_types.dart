...
class EventsTypes extends StatefulWidget {
  static const routeName = '/eventsTypes';
  const EventsTypes({super.key});

  @override
  State<EventsTypes> createState() => _EventsTypesState();
}

class _EventsTypesState extends State<EventsTypes> {
  @override
